...
namespace Arkivverket.Arkade.Core.Metadata
{
    public class EacCpfCreator
    {
        ...
        {
            eaccpf eaccpf = Create(diasPackage.Uuid);
            ...
            FileInfo targetFileName = diasPackage.Archive.WorkingDirectory.DescriptiveMetadata().WithFile(ArkadeConstants.EacCpfXmlFileName);
