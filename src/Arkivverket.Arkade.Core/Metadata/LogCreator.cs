...
{
    public class LogCreator : IMetadataCreator
    {
        ...
        {
            premisComplexType premis = Create(outputDiasPackage.Id);
            ...
            FileInfo targetFileName = outputDiasPackage.WorkingDirectory.Root().WithFile(ArkadeConstants.LogXmlFileName);
