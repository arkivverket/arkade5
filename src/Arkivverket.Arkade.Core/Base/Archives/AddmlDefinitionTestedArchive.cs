...
public abstract class AddmlDefinitionTestedArchive(ArchiveContent content, DirectoryInfo processingDirectory)
    : AddmlBasedArchive(content, processingDirectory)
{
