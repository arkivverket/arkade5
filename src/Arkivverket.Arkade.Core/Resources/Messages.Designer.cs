...
namespace Arkivverket.Arkade.Core.Resources {
    ...
    public class Messages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to {0} is not a unique value.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to No valid package identity (UUID) was found in the loaded package's METS.
        /// </summary>
        public static string DiasPackageIdentityNotFound {
            get {
                return ResourceManager.GetString("DiasPackageIdentityNotFound", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Validation of Noark4-extracts is not supported.
        /// </summary>
        public static string Noark4ValidationNotSupported {
            get {
                return ResourceManager.GetString("Noark4ValidationNotSupported", resourceCulture);
            }
        }
