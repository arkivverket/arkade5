...
namespace Arkivverket.Arkade.Core.Resources {
    ...
    public class AddmlMessages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to ADDML record is specified with a fixed length of {0} characters (included record separator), but {1} characters were read.
        /// </summary>
        public static string RecordFixedLengthMismatch {
            get {
                return ResourceManager.GetString("RecordFixedLengthMismatch", resourceCulture);
            }
        }
