...
namespace Arkivverket.Arkade.Core.Tests.Base.Addml.Processes
{
    public class A_14_ControlNotUsedRecordDefTest : LanguageDependentTest
    {
        ...
        public void ShouldReportIfRecordDefinitionIsNotInUse()
        {
            ...
            testRun.TestResults.TestsResults[0].Location.ToString().Should().Be(recordDefinitionNotInUse.GetIndex().ToString());
            testRun.TestResults.TestsResults[0].Message.Should().Be("Posttypen er ikke i bruk");
        }
