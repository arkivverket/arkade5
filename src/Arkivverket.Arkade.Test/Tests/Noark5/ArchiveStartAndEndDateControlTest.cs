...
{
    public class ArchiveStartAndEndDateControlTest
    {
        [Fact]
        public void EqualDatesInArchiveAndJournalsIsAlwaysOk()
        {
            ...
            const string testdataDirectory = "TestData\\Noark5\\StartAndEndDateControl\\SharpSeparation";
        ...
        public void UnEqualDatesInJournalsIsNeverOk() // Should contain errors
        {
            ...
            const string testdataDirectory =
                "TestData\\Noark5\\StartAndEndDateControl\\SoftSeparationAndUnEqualJournals";
        ...
        public void DatesInArchiveThatIsDifferentFromDatesInJournalsIsOkWithSoftSeparation()
        {
            ...
            const string testdataDirectory = "TestData\\Noark5\\StartAndEndDateControl\\SoftSeparation";
